...
_ANTHROPIC_LADDER = (
    ...
    ("cloud-large",    "claude-opus-5-5",   ("opus", "claude"),   4.0,  20.0,  1_000_000),   # Opus 5.5 since 2026-09-22 ($4/$20, cache read $0.20)
    ("cloud-exquisite", "claude-fable-5",   ("fable", "flagship", "exquisite"),         10.0, 50.0,  1_000_000),
)
